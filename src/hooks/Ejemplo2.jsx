...
const Ejemplo2 = () => {
     ...
     * se ejecuta aquello que esté dentor del useEffect
     */
     ...
     * En caso de que cambie contador 2, no habrá ejecucion
     */
     ...
     * Cada vez que haya un cambio en contador 1, se ejecuta lo que diga useEffect()
     * Cada vez que haya un cambio en contador 2, se ejecuta lo que diga useEffect()
     */
